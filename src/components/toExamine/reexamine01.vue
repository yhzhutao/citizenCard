...
export default {
  ...
  methods: {
    ...
    goNext() {
      ...
      that.$router.push({ name: "reexmaine02" });
    },
    getTime(e) {
      const d = new Date(e);
      const resDate =
    ...
    getCode() {
      ...
      that
        .$post(that.$api.api + "/gw/a1/application/sendEmail", {
  ...
  mounted() {
    ...
    if (localStorage.getItem("username")) {
      ...
      this.inputValue[8].name = localStorage.getItem("username1");
    }
